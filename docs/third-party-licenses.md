...
| `python-dateutil`            | 2.9.0.post0  | Dual License    | Transitiva de botocore/boto3; metadados declaram BSD-3-Clause e Apache-2.0 em conjunto, ambas permissivas, exceção restrita à versão. | EasyDentist maintainers | 2026-09-22; reavaliar em cada atualização |
